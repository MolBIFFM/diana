        ...
        for time in ppi_network.get_times():
            ...
            for tag in pipeline.configuration.cytoscape_styles.SETTINGS[len(ptms) - 1]:
                ...
                for name, setting in pipeline.configuration.cytoscape_styles.SETTINGS[
                    ...
                    visual_property = ET.SubElement(
                        tags[tag],
                        "visualProperty",
                        attrib={"name": name, "default": setting["default"]},
                    )
                    if setting.get("passthroughMapping"):
                        ET.SubElement(
                            ...
                            "passthroughMapping",
                            attrib={
                                "attributeName": setting["passthroughMapping"][
                                    "attributeName"
                                ],
                                "attributeType": setting["passthroughMapping"][
                                    "attributeType"
                                ],
                            },
                        )
                        ...
                        discrete_mapping = ET.SubElement(
                            ...
                            "discreteMapping",
                            attrib={
                                "attributeName": setting["discreteMapping"][
                                    "attributeName"
                                ].format(time=time),
                                "attributeType": setting["discreteMapping"][
                                    "attributeType"
                                ],
                            },
                        )
                        for attribute_value, value in setting["discreteMapping"][
                            ...
                            ET.SubElement(
                                ...
                                "discreteMappingEntry",
                                attrib={
                                    "attributeValue": attribute_value.format(ptms=ptms),
                                    "value": value,
                                },
                            )
            ...
            for i, ptm in enumerate(ptms):
                for visual_property in visual_style.find("node").findall(
                    ...
                    if visual_property.get("name") == "NODE_CUSTOMGRAPHICS_{}".format(
                        i + 1
                    ):
                        visual_property.set(
                            "default",
