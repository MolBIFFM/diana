...
```
The version of the BioGRID database to use. The default setting is `null`, corresponding to the latest version. Missing numbers are set to 0 towards the minor version.
